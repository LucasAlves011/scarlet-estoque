...
//    private Tipo tipo;
    ...
    public boolean verificarDisponibilidade(TamanhoEnum tamanhoEnum, int unidades) throws ObjectNotFoundException, TamanhoIncompativelException {
        ...
        if (tamanhoEnum == null) {
            if (this.getAvulso() == null ) throw  new TamanhoIncompativelException("Não é possível adicionar o tamanho " + Optional.ofNullable(tamanhoEnum.getTamanho()).orElse("")
            ...
            if (this.getNominal() == null ) throw  new TamanhoIncompativelException("Não é possível adicionar o tamanho " + tamanhoEnum.getTamanho()
            ...
            if (this.getNumerico() == null ) throw  new TamanhoIncompativelException("Não é possível adicionar o tamanho " + tamanhoEnum.getTamanho()
